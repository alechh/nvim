...
- leader + g -- поиск по всем словам в проекте (grep)
    - Ctrl + q -- открыть результаты поиска в отдельном буффере внизу
...
- leader + z -- открыть список открытых буфферов
- leader + xx -- Открыть список предупреждений и ошибок в файле
- leader + a -- Открыть боковую панель со структурой кода
- s + {char1} + {char2} -- быстрая навигация к нужному слову (плагин leap)
